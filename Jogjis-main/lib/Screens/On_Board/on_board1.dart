...
class on_board1 extends StatefulWidget {
  const on_board1({super.key});

  @override
  State<on_board1> createState() => _OnBoard1State();
}

class _OnBoard1State extends State<on_board1> with SingleTickerProviderStateMixin {
