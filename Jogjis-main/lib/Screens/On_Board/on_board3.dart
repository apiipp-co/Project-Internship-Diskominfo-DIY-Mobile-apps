...
class on_board3 extends StatefulWidget {
  const on_board3({super.key});

  @override
  State<on_board3> createState() => _OnBoard3State();
}

class _OnBoard3State extends State<on_board3> with SingleTickerProviderStateMixin {
